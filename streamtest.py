...
def getTweets():
    ...
    if search != None:
        ...
        next_url += '&search=' + search + '&search_type=' + \
            search_type + '&search_value=' + search_value
        prev_url += '&search=' + search + '&search_type=' + \
            search_type + '&search_value=' + search_value
...
def downloadtweets():
    ...
    si = io.StringIO()
    fieldnames = ['retweet_count', 'user_friends_count', 'created_at', 'user_followers_count', 'reply_count', 'name', 'location', 'keyword', 'favorite_count',
                  'user_time_zone', 'tweet_hashtags', 'lang', 'user_id', 'text', 'user_description', 'screen_name', 'retweeted', 'timestamp_ms', '_id', 'tweet_text_urls', 'url']
